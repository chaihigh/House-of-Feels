...
west_hall = Room("west hallway", "the hallway that is west", [], [], [], [], "the ")
...
bees_room.adj = [north_hall, alexs_room]
bees_room.inter = [alexs_bath, bees_closet]
bees_closet.adj = [bees_room]
alexs_room.adj = [west_hall, bees_room]
...
kess_room.adj = [sec_hall, levis_room]
kess_room.inter = [levis_bath, kess_closet]
kess_closet.adj = [kess_room]
chics_room.adj = [sec_hall, coms_room]
chics_room.inter = [chics_bath, chics_closet]
chics_bath.adj = [chics_room, coms_room]
chics_closet.adj = [chics_room]
coms_room.adj = [sec_hall, chics_room]
coms_closet.adj = [coms_room]
coms_room.inter = [chics_bath, coms_closet]
blacks_room.adj = [north_hall, lucys_room]
blacks_room.inter = [lucys_bath, blacks_closet]
blacks_closet.adj = [blacks_room]
basement.adj = [living_room]
west_hall.adj = [living_room, landing, alexs_room, aidans_room]
north_hall.adj = [living_room, bees_room, lucys_room, blacks_room]
landing.adj = [sun_room, sec_hall]
sun_room.adj = [landing]
sec_hall.adj = [coms_room, chics_room, levis_room, kess_room, asters_room]
